package springBootFirstTry.dto;
...
import javax.persistence.Table;
 /*
  * This the the data transfer OBJ for MVC, as well as the database table
  */
@Entity
@Table(name = "mars_api_preferences")// rename table in database to mars_api_preferences

public class HomeDto {
	private Long userId; // for preference remember and primary ID in data base.
	private String marsApiRoverData;
	private Integer marsSol;
	private Boolean cameraFhaz;
	private Boolean cameraRhaz;
	private Boolean cameraMast;
	private Boolean cameraChemcan;
	...
	@Id @GeneratedValue(strategy = GenerationType.IDENTITY) //set the primary key of database
	...
	@Column(length=20)// change max length
	...
	public Boolean getCameraChemcan() {
		return cameraChemcan;
	}
	public void setCameraChemcan(Boolean cameraChemcan) {
		this.cameraChemcan = cameraChemcan;
	}
	...
	public String toString() {
		return "HomeDto [userId=" + userId + ", marsApiRoverData=" + marsApiRoverData + ", marsSol=" + marsSol
				...
				+ ", cameraChemcan=" + cameraChemcan + ", cameraMahli=" + cameraMahli + ", cameraMardi=" + cameraMardi
